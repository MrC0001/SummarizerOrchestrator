...
public class SummarizationServiceImpl implements SummarizationService {
     ...
     * Each provider is called in parallel using {@link CompletableFuture}, allowing
     * concurrent execution to improve performance and reduce overall processing time.
     *
     * <p>This method ensures that all provider calls are completed before collecting
     * the results, handling any exceptions encountered during the execution of
     * individual provider calls.</p>
     *
     * @param request The summarization request DTO containing input data for the providers.
     *                Must not be {@code null}.
     * @return A list of {@link SummarizationResponseDTO}, containing summaries generated by
     *         all providers or error messages in case of exceptions.
